...
let last = inputString2.charCodeAt(inputString2.length-1);
let swappedString = String.fromCharCode(last) + inputString2.substring(1, inputString2.length - 1) + String.fromCharCode(first); // Your code here
